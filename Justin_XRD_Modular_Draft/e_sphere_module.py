...
"""
Projects the reciprocal lattice points and filters those that satisfy the diffraction condition
"""
...
class EwaldSphere:
    ...
    def __init__(self, rotated_grain, experiment, tolerance):
        ...
        # distances of reciprocal lattice vector tips of the grain from the center of the Ewald Sphere. 
        # consider erasing center[1] and center[2], as they will likely permanently be 0, 
        # and this would just raise computational overhead 
